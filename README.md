...
[![Build Status](https://travis-ci.org/octokit/request-error.js.svg?branch=master)](https://travis-ci.org/octokit/request-error.js)
...
```js
const myrequest = require("@octokit/request-error").defaults({
